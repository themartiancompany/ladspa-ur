...
source=(
  "${url}/download/${_Pkg}_${pkgver}.tgz"
  "${pkgname}-1.17-plugin_underlinking.patch"
  "fix-memleak-in-plugin-scanning.patch"
)
sha512sums=(
  'c096e70d245c50ffad379f2c9aab2735c205dfe7c27b5710cad6e43b39f8accc7b8bd2cd7ebbea2c399ad76018b3d4c701ed271de552d098b12ab218a58f0497'
...
b2sums=(
  '234f6c42e2736d250259b9473f70def136bcf57c2395d79e3a3cd6da715181dbfa87c1c35e8f0b840e0c5c00c39bfbb93d1ddd73b4c1547140caa080589d91b3'
...
prepare() {
  ...
  patch \
    -Np1 \
    -i \
    "../${_pkg}-1.17-plugin_underlinking.patch"
...
package() {
  ...
  _make_options=(
    ...
    install
    -C \
      "${_Pkgname}_${pkgver}/src"
  )
  make \
    "${_make_options[@]}"
  install \
    -vDm 644 \
    "${_Pkg}_${pkgver}/doc/"*"."{"html","txt"} \
    -t \
